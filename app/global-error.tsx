...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="bg-slate-50 text-slate-900 min-h-screen flex items-center justify-center p-6 antialiased">
        <div className="max-w-md w-full bg-white border border-slate-200 rounded-2xl p-6 shadow-sm text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-1">
              {error.message || 'Global portal exception occurred. Click reset to restore portal.'}
            </p>
          </div>
          <button
            onClick={() => reset()}
